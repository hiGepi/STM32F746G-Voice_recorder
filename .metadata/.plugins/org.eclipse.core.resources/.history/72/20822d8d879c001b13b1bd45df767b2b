...
void RecordTask(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(Record, RecordTask, osPriorityNormal, 0, 1024);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, LED13_Pin|LED11_Pin|LED12_Pin|LED2_Pin
  ...
  /*Configure GPIO pins : LED13_Pin LED11_Pin LED12_Pin LED2_Pin
                           LED18_Pin */
  GPIO_InitStruct.Pin = LED13_Pin|LED11_Pin|LED12_Pin|LED2_Pin
                          |LED18_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void StartDefaultTask(void const * argument)
{
  /* USER CODE BEGIN 5 */
	...
	uint8_t wtext[] = "Camilo est-il sage ?"; /* File write buffer */
...
/* USER CODE BEGIN Header_RecordTask */
/**
* @brief Function implementing the Record thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_RecordTask */
void RecordTask(void const * argument)
{
  /* USER CODE BEGIN RecordTask */
